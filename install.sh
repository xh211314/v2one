...
nginx_install() {
    ...
    wget -4 -nc --no-check-certificate -O ${nginx_openssl_src}/openssl-${openssl_version}.tar.gz \
--user-agent="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/99.0 Safari/537.36" \
-L https://www.openssl.org/source/openssl-${openssl_version}.tar.gz
